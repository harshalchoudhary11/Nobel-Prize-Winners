...
//     function displayWinners() {
//         const filteredPrizes = prizes.filter(prize => prize.year == selectedYear && prize.category == selectedCategory);
//         winnersList.innerHTML = filteredPrizes.map(prize => `
//             <li key="${prize.year + prize.category}">
//                 <strong class="text-white">
//                     Year: ${prize.year}, Category: ${prize.category}
//                 </strong>
//                 <ul>
//                     ${prize.laureates.map(laureate => `
//                         <li key="${laureate.id}" class="text-blue">
//                             ${laureate.firstname} ${laureate.surname}
//                         </li>`).join('')}
//                 </ul>
//             </li>`).join('');
...
//     yearsSelect.addEventListener("change", handleYearChange);
